...
<div class="container">
  ...
  <ul class="pagination justify-content-center">
	  <c:if test="${pag > 1}">
	   <li class="page-item"><a href="boList.bo?pag=1&pageSize=${pageSize}&sw=3&mid=${sMid}" class="page-link text-secondary">◀◀</a></li>
	  </c:if>
	  <c:if test="${curBlock > 0}">
	  	<li class="page-item"><a href="boList.bo?pag=${(curBlock-1)*blockSize + 1}&pageSize=${pageSize}&sw=3&mid=${sMid}"class="page-link text-secondary">◀</a></li>
	  </c:if>
	  <c:forEach var="i" begin="${(curBlock*blockSize)+1}" end="${(curBlock*blockSize)+blockSize}">
	  <c:if test="${i <= totPage && i == pag}">
	    <li class="page-item active"><a href="boList.bo?pag=${i}&pageSize=${pageSize}&sw=3&mid=${sMid}" class="page-link text-light bg-secondary border-secondary"><b>${i}</b></a></li>
	  </c:if>
	  <c:if test="${i <= totPage && i != pag}">
	    <li class="page-item"><a href='boList.bo?pag=${i}&pageSize=${pageSize}&sw=3&mid=${sMid}' class="page-link text-secondary">${i}</a></li>
	  </c:if>
	  </c:forEach>
	  <c:if test="${curBlock < lastBlock}">
	    <li class="page-item"><a href="boList.bo?pag=${(curBlock+1)*blockSize + 1}&pageSize=${pageSize}&sw=3&mid=${sMid}" class="page-link text-secondary">▶</a></li>
	  ...
	  <c:if test="${pag != totPage}">
			<li class="page-item"><a href="boList.bo?pag=${totPage}&pageSize=${pageSize}&sw=3&mid=${sMid}" class="page-link text-secondary">▶▶</a></li>
	  </c:if>
  </ul>
 </div>
   </div>
  ...
  <ul class="pagination justify-content-center">
	  <c:if test="${pag > 1}">
	   <li class="page-item"><a href="boList.bo?pag=1&pageSize=${pageSize}&sw=4&mid=${sMid}" class="page-link text-secondary">◀◀</a></li>
	  </c:if>
	  <c:if test="${curBlock > 0}">
	  	<li class="page-item"><a href="boList.bo?pag=${(curBlock-1)*blockSize + 1}&pageSize=${pageSize}&sw=4&mid=${sMid}"class="page-link text-secondary">◀</a></li>
	  </c:if>
	  <c:forEach var="i" begin="${(curBlock*blockSize)+1}" end="${(curBlock*blockSize)+blockSize}">
	  <c:if test="${i <= totPage && i == pag}">
	    <li class="page-item active"><a href="boList.bo?pag=${i}&pageSize=${pageSize}&sw=4&mid=${sMid}" class="page-link text-light bg-secondary border-secondary"><b>${i}</b></a></li>
	  </c:if>
	  <c:if test="${i <= totPage && i != pag}">
	    <li class="page-item"><a href='boList.bo?pag=${i}&pageSize=${pageSize}&sw=4&mid=${sMid}' class="page-link text-secondary">${i}</a></li>
	  </c:if>
	  </c:forEach>
	  <c:if test="${curBlock < lastBlock}">
	    <li class="page-item"><a href="boList.bo?pag=${(curBlock+1)*blockSize + 1}&pageSize=${pageSize}&sw=4&mid=${sMid}" class="page-link text-secondary">▶</a></li>
	  ...
	  <c:if test="${pag != totPage}">
			<li class="page-item"><a href="boList.bo?pag=${totPage}&pageSize=${pageSize}&sw=4&mid=${sMid}" class="page-link text-secondary">▶▶</a></li>
	  </c:if>
  </ul>
 </div>  
   </div>
